            ...
            <div className="sidebar-widget search-widget mb-30 wow fadeInUp bg-white">
                ...
                <form>
                    <div className="form_group mb-20">
                        ...
                        <input onChange={onChangeSearchText} value={searchText} type="text" className="form_control" placeholder="Nhập tên lễ hội...." required />
                    </div>
                    <div className="form_group mb-20">
                        <span className='d-flex justify-contnet-start mb-10'>Ngày bắt đầu</span>
                        <input onChange={onChangeStartDate} value={startDate} type="date" className="form_control" placeholder="" required />
                    </div>
                    <div className="form_group mb-20">
                        <span className='d-flex justify-contnet-start mb-10'>Ngày kết thúc</span>
                        <input onChange={onChangeEndDate} value={endDate} type="date" className="form_control" placeholder="" required />
                    </div>
                </form>
            </div>
        </div>
